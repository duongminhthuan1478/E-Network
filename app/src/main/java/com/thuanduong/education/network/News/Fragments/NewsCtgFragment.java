...
import com.thuanduong.education.network.Ultil.AsynTask.NewsCtgContentAsyncTask;
 ...
 * Get tu dong All các bài viết của mục tin tức từ nguồn website:
 * https://duytan.edu.vn/tin-tuc
 */
public class NewsCtgFragment extends Fragment implements NewsCtgContentAsyncTask.DataChangeInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView =  inflater.inflate(R.layout.fragment_news_ctg, container, false);
        findIDAndInitRecyclerview(rootView);
        new NewsCtgContentAsyncTask(this).execute();
        return rootView;
    }

    private void findIDAndInitRecyclerview(View rootView) {
        mProgressDialogLoadingBar = new ProgressDialog(getContext());
        mNewsListRecyclerview = rootView.findViewById(R.id.news_recyclerview);
        ...
        mNewsListRecyclerview.addItemDecoration(dividerItemDecoration);
    }
