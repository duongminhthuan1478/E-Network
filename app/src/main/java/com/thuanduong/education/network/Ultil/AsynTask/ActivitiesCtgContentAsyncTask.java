...
public class ActivitiesCtgContentAsyncTask extends AsyncTask<Void, Void, ArrayList<News>> {
    ActivitiesCtgContentAsyncTask.DataChangeInterface dataChangeInterface;
    private String LOG_TAG = "ActivitiesCtgContentAsyncTask";

    public ActivitiesCtgContentAsyncTask(ActivitiesCtgContentAsyncTask.DataChangeInterface dataChangeInterface){
    ...
    protected  ArrayList<News> doInBackground(Void... voids) {
        ...
        try {
            Document doc = Jsoup.connect(Common_Constants.GET_ACTIVITIES_CATEGORY).timeout(10 * 1000).get();
            // 1st priority
